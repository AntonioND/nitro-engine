 ...
 *  \brief Set size of a sprite. If you want to flip the sprite, just use a negative value.
...
If 0, no operations will be done when drawing the sprite. If different, 2D view will be
rotated using as center: spritecoordinates + (spritesize/2). */
...
2D view is scaled using as center the center of the sprite. */
#define NE_SpriteSetScale(sprite,scale) NE_SpriteSetScaleI(sprite,floattof32(scale))
 ...
 *  \brief Set priority of a sprite. The lower the vaue is, the higher the priority is.
 *  \param sprite Sprite. 
...
/*! \fn    void NE_SpriteSetParams(NE_Sprite * sprite, u8 alpha, u8 id, u32 color);
...
If you want to make a sprite transparent over another one transparent you have to 
make them have different ID. */
 ...
 *  \brief Draws selected sprite. You have to use NE_2DViewInit before drawing any 
           sprite with this function.
 ...
 *  \brief Sets current view to a 3D orthogonal view to draw 2D objects using 3D hardware. */
...
Be careful if you print text after this. Text functions are prepared to avoid useless work, 
for example, they don't draw text out of the screen. They don't know if you have rotated the
view or not. If you want to draw rotated text be careful, print as less as you can. */
 ...
 *  \param y (x,y) Coordinates.
 *  \param scale Scale factor. */
#define NE_2DViewScaleByPosition(x,y,s) NE_2DViewScaleByPositionI(x,y,floattof32(s))

/*! \fn    void NE_2DViewRotateScaleByPositionI(int x, int y, int rotz, int scale);
...
#define NE_2DViewRotateScaleByPosition(x,y,r,s) NE_2DViewRotateScaleByPositionI(x,y,r,floattof32(s))
...
/*! \fn    void NE_2DDrawQuadGradient(s16 x1, s16 y1, s16 x2, s16 y2, s16 z, u32 color1,
...
/*! \fn    void NE_2DDrawTexturedQuad(s16 x1, s16 y1, s16 x2, s16 y2, s16 z, NE_Material * mat);
...
/*! \fn    void NE_2DDrawTexturedQuadColor(s16 x1, s16 y1, s16 x2, s16 y2, s16 z, NE_Material * mat, 
					u32 color);
...
/*! \fn    void NE_2DDrawTexturedQuadGradient(s16 x1, s16 y1, s16 x2, s16 y2, s16 z, NE_Material * mat,
